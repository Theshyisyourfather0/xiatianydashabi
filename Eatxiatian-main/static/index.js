...
function shareText(score) {
    ...
    SubmitResults();
	if (score <= 15) return '卑微-你被王哥做掉了';
    if (score <= 30) return '普通-你与王哥五五开';
    if (score <= 60) return '优秀-王哥杀手';
    if (score <= 90) return '史诗-王哥屠杀者';
    if (score <= 120) return '传说-虐杀王哥';
	if (score <= 150) return '奇迹-杀王成瘾';
	if (score <= 180) return '神话-屠·王·者';
    return '王哥被轻松做掉了~';
}
